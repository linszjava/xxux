...
import com.lin.xxux.common.utils.date.DateUtil;
import com.lin.xxux.constant.RedisConst;
import com.lin.xxux.model.activity.SeckillTime;
import com.lin.xxux.service.activity.mapper.SeckillTimeMapper;
import com.lin.xxux.service.activity.service.SeckillSkuService;
...
/**
* @author linsz
* @description 针对表【seckill_time(秒杀活动场次)】的数据库操作Service实现
* @createDate 2023-12-26 09:21:05
*/
@Service
public class SeckillTimeServiceImpl extends ServiceImpl<SeckillTimeMapper, SeckillTime>
    implements SeckillTimeService {
