...
import com.lin.xxux.common.rabbitmq.service.RabbitmqService;
...
import com.lin.xxux.service.product.mapper.SkuInfoMapper;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoMapper, SkuInfo>
    ...
    public SkuInfoVo getSkuInfoVo(Long id) {
        ...
        List<SkuImage> imageList = skuImagesService.findBySkuId(id);
        List<SkuPoster> posterList = skuPosterService.findBySkuId(id);
        List<SkuAttrValue> attrValueList = skuAttrValueService.findBySkuId(id);
        BeanUtils.copyProperties(skuInfo, skuInfoVo);
        skuInfoVo.setSkuImagesList(imageList).setSkuPosterList(posterList).setSkuAttrValueList(attrValueList);
        return skuInfoVo;
    }
    ...
    public void publish(Long skuId, Integer status) {
        ...
        if(status == 1) {
            ...
            //TODO 商品上架 发送mq消息更新es数据
            rabbitmqService.sendMessage(MQConst.EXCHANGE_GOODS_DIRECT,
